...
function devolverString(str) {
  var Saludo = (str);// "Return" la string provista: str
...
function resta(x, y) {
  var restar = x - y;// Resta "y" de "x" y devuelve el valor
  return restar;     // Tu código:
}

function multiplica(x, y) {
  var multiplicar = x * y;// Multiplica "x" por "y" y devuelve el valor
  return multiplicar;     // Tu código:
}

function divide(x, y) {
  var dividir = x / y;// Divide "x" entre "y" y devuelve el valor
